...
function CompanyFilter() {
  return (
    <>
        <div className=' flex w-[50%] rounded-xl items-center justify-between h-[45px] bg-[#FDFCF7] border-[1px] border-[#584F4F] mt-5 '>

            <div className=' flex w-[90%] items-center justify-between'>

                <div className=' ml-5 text-[15px] text-[#AAA9A5]'>Filtre por Marcas</div>
                ...
                <svg
                    ...
                    <path
                        fill="#AAA9A5"
                        fillOpacity="0.72"
                        d="M8.366 13.5a1 1 0 01-1.732 0L.139 2.25a1 1 0 01.866-1.5h12.99a1 1 0 01.866 1.5L8.366 13.5z"
                    ></path>
                </svg>

            </div>

            <div className=' flex items-center justify-center w-[35px] border-l border-[#584F4F] border-opacity-75 h-full mr-2'>
